...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [46] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(50),
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(75),
  [52] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(7),
  [55] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(89),
  [58] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(48),
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(85),
  [64] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(8),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_self_closing_tag, 3),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_self_closing_tag, 3),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 1),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 1),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_self_closing_tag, 4),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_self_closing_tag, 4),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_doctype, 4),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_doctype, 4),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_element, 3),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_style_element, 3),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_element, 3),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_script_element, 3),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 2),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 2),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 3),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 3),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_erroneous_end_tag, 3),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_erroneous_end_tag, 3),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_start_tag, 4),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_start_tag, 4),
  ...
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_element, 2),
  [117] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_style_element, 2),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_start_tag, 3),
  ...
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_start_tag_repeat1, 2), SHIFT_REPEAT(43),
  ...
  [142] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_start_tag_repeat1, 2), SHIFT_REPEAT(46),
  [145] = {.entry = {.count = 1, .reusable = true}}, SHIFT(65),
  [147] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [149] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 1),
  ...
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 3),
  [179] = {.entry = {.count = 1, .reusable = true}}, SHIFT(88),
  [181] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quoted_attribute_value, 2),
  [185] = {.entry = {.count = 1, .reusable = true}}, SHIFT(72),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quoted_attribute_value, 3),
  ...
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_start_tag, 4),
  [203] = {.entry = {.count = 1, .reusable = false}}, SHIFT(68),
  [205] = {.entry = {.count = 1, .reusable = true}}, SHIFT(83),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_start_tag, 4),
  [209] = {.entry = {.count = 1, .reusable = false}}, SHIFT(53),
  [211] = {.entry = {.count = 1, .reusable = true}}, SHIFT(79),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_start_tag, 3),
